...
script_authors("Masaharu Morimoto (Design & Implementation)","Brad Ringer (Boilerplate & Consulting Only - No Script Use/Design/Implementation/Legal Responsibility or Involement)")
